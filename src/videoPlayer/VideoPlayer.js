    ...
    */
    ...
    renderTopControls() {
        return(
            <Animated.View style={[
                ...
                <Image
                    source={ require( '../resource/vp/top-vignette.png' ) }
    ...
    renderBack() {
        return this.renderControl(
            <Image
                source={ require( '../resource/vp/back.png' ) }
    ...
    renderVolume() {
        return (
            <View style={ styles.volume.container }>
                ...
                >
                    <Image style={ styles.volume.icon } source={ require( '../resource/vp/volume.png' ) } />
                </View>
            </View>
        );
    }
     ...
     */
    renderFullscreen() {
        let source = this.state.isFullscreen === true ? require( '../resource/vp/shrink.png' ) : require( '../resource/vp/expand.png' );
        return this.renderControl(
            <Image source={ source } />,
            this.methods.toggleFullscreen,
    ...
    renderBottomControls() {
        return(
            ...
            <Image
                source={ require( '../resource/vp/bottom-vignette.png' ) }
                style={[ styles.controls.column, styles.controls.vignette,
            ]}>
                <View style={[
     ...
     */
    renderPlayPause() {
        let source = this.state.paused === true ? require( '../resource/vp/play.png' ) : require( '../resource/vp/pause.png' );
        return this.renderControl(
            <Image source={ source } />,
        ...
        if ( this.state.loading ) {
            return (
                <View style={ styles.loader.container }>
                    <Animated.Image source={ require( '../resource/vp/loader-icon.png' ) } style={[
                        styles.loader.icon,
                        { transform: [
        ...
        if ( this.state.error ) {
            return (
                <View style={ styles.error.container }>
                    <Image source={ require( '../resource/vp/error-icon.png' ) } style={ styles.error.icon } />
